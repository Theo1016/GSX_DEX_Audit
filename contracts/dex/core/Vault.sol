...
contract Vault is ReentrancyGuard, IVault {
    ...
    function liquidatePosition(address _account, address _collateralToken, address _indexToken, bool _isLong, address _feeReceiver) override external nonReentrant {
